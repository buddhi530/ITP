...
//                                                                    mysqli_query($con, $sql11);
        ...
        echo "<script>window.location = 'vehicle.php?msg=SUPPLIER HAS BEEN REMOVED ! ';</script>";
    } else {
        echo "<script>window.location = 'vehicle.php?msge=ROMVING SUPPLIER FAILED ! CONTACT ADMINISTRATOR ';</script>";
    }
}
//
?>
